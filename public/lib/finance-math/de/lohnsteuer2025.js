// GENERATED from scripts/pap/Lohnsteuer2025.xml (official BMF Programmablaufplan pseudocode).
// Do not edit — regenerate with: node scripts/gen-de-lohnsteuer.mjs
import { BigDecimal } from "./bigdecimal.js";

// Inputs:  af, AJAHR, ALTER1, f, JFREIB, JHINZU, JRE4, JRE4ENT, JVBEZ, KRV, KVZ, LZZ, LZZFREIB, LZZHINZU, MBV, PKPV, PKV, PVA, PVS, PVZ, R, RE4, SONSTB, SONSTENT, STERBE, STKL, VBEZ, VBEZM, VBEZS, VBS, VJAHR, ZKF, ZMVB
// Outputs: BK, BKS, LSTLZZ, SOLZLZZ, SOLZS, STS, VKVLZZ, VKVSONST, VFRB, VFRBS1, VFRBS2, WVFRB, WVFRBO, WVFRBM
export class Lohnsteuer2025 {
  ...
  MZTABFB() {
    ...
    if (this.STKL == 1) {
      ...
      this.KFB= (this.ZKF.multiply (BigDecimal.valueOf (9600))).setScale (0, BigDecimal.ROUND_DOWN);
    } else {
      if (this.STKL == 2) {
        ...
        if (this.STKL == 3) {
          ...
          if (this.STKL == 4) {
            this.SAP= BigDecimal.valueOf (36);
            this.KFB= (this.ZKF.multiply (BigDecimal.valueOf (4800))).setScale (0, BigDecimal.ROUND_DOWN);
          } else {
            if (this.STKL == 5) {
              this.SAP= BigDecimal.valueOf (36);
  ...
  UPTAB25() {
    if (this.X.compareTo(this.GFB.add(this.ZAHL1)) == -1) {
      ...
      if (this.X.compareTo (BigDecimal.valueOf (17444)) == -1) {
        ...
        this.RW= this.Y.multiply (BigDecimal.valueOf (932.30));
        ...
        if (this.X.compareTo (BigDecimal.valueOf (68481)) == -1) {
          this.Y= (this.X.subtract (BigDecimal.valueOf (17443))).divide (this.ZAHL10000, 6, BigDecimal.ROUND_DOWN);
          ...
          this.ST= (this.RW.add (BigDecimal.valueOf (1015.13))).setScale (0, BigDecimal.ROUND_DOWN);
        } else {
          if (this.X.compareTo (BigDecimal.valueOf (277826)) == -1) {
            this.ST= ((this.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (10911.92))).setScale (0, BigDecimal.ROUND_DOWN);
          } else {
            this.ST= ((this.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (19246.67))).setScale (0, BigDecimal.ROUND_DOWN);
          }
        }
      }
    }
