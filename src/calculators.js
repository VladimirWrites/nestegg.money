...
// Human-readable tool titles for MCP clients (tools/list `title`). One per calculator —
// a test enforces full coverage.
export const TOOL_TITLES = {
  "amortization": "Amortization Schedule",
  "loan-payoff": "Loan Payoff",
  "future-value": "Future Value",
  "contributions": "Future Value of Contributions",
  "cagr": "CAGR",
  ...
  "inflation-adjust": "Inflation Adjust",
  "effective-rate": "Effective Rate",
  "npv": "NPV",
  "irr": "IRR",
  "refi-breakeven": "Refinance Break-Even",
  "emergency-fund": "Emergency Fund",
  "mortgage-affordability": "Mortgage Affordability",
  "debt-payoff": "Debt Payoff",
  "portfolio-longevity": "Portfolio Longevity",
  "present-value": "Present Value",
  "required-return": "Required Return",
  "yield-to-maturity": "Yield to Maturity",
  "tax-from-brackets": "Tax from Brackets",
  "margin-markup": "Margin & Markup",
  "compound-interest": "Compound Interest",
  "de-gross-to-net": "German Gross-to-Net (manual figures)",
  "de-net-salary": "German Net Salary (exact, by tax year)",
  "de-abgeltungsteuer": "German Capital Gains Tax (Abgeltungsteuer)",
  "de-kindergeld": "German Child Benefit (Kindergeld)",
  "de-midijob": "German Midijob Contributions",
  "de-rentenpunkte": "German Pension Points (Rentenpunkte)",
  "vat": "VAT",
  "roi": "ROI",
  ...
  "zero-coupon-price": "Zero-Coupon Price",
  "accrued-interest": "Accrued Interest",
  "black-scholes": "Black-Scholes Option Price",
  "option-greeks": "Option Greeks",
  "put-call-parity": "Put-Call Parity",
  "option-breakeven": "Option Break-Even",
  "intrinsic-time-value": "Intrinsic & Time Value",
  "annuity-pv": "Annuity Present Value",
  "annuity-fv": "Annuity Future Value",
  ...
  "xirr": "XIRR",
  "loan-apr": "Loan APR",
  "interest-only-payment": "Interest-Only Payment",
  "balloon-loan": "Balloon Loan",
  "ltv": "Loan-to-Value",
  "dti": "Debt-to-Income",
  "credit-card-payoff": "Credit Card Payoff",
  "points-breakeven": "Points Break-Even",
  "biweekly-payoff": "Biweekly Payoff",
  "cap-rate": "Cap Rate",
  ...
  "declining-balance-depreciation": "Declining-Balance Depreciation",
  "double-declining-depreciation": "Double-Declining Depreciation",
  "sum-of-years-digits": "Sum-of-Years' Digits Depreciation",
  "units-of-production-depreciation": "Units-of-Production Depreciation",
  "net-worth": "Net Worth",
  "budget-50-30-20": "50/30/20 Budget Split",
  "tip-split": "Tip Split",
  "discount": "Discount",
